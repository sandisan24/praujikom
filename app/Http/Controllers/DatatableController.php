...
class DatatableController extends Controller
{
    ...
    public function barang_json()
    {
        ...
        ->addColumn('action', function ($u) {
            return '<a href="/barang/edit/'.$u->id_barang.'" class="btn btn-sm btn-warning text-white swal-edit-button"">Edit </a>
           <a href="/barang/qrcode/'.$u->id_barang.'"  class="btn btn-sm text-white btn-primary" ">QR Code </a>
           <a href="/barang/delete/'.$u->id_barang.'"  class="btn btn-sm text-white btn-danger"">Hapus </a>
            ';
        })
